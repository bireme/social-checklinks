                            ...
                            <ul class="nav pull-right">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li <%if(lang.equals("en")) {%> class="disabled"<%}%>><a href="javascript:postToUrl('<%=response.encodeRedirectURL("showFixedUrls.jsp")%>', {id:'<%=id%>',group:'<%=group%>',lgroup:'<%=lgroup%>',lang:'en',dbFilter:'<%=dbFilter%>',collCenterFilter:'<%=collCenterFilter%>',order:'<%=order%>',url:'<%=url_E%>',brokenUrl:'<%=brokenUrl_E%>'});">English</a></li>
                                        <li <%if(lang.equals("pt")) {%> class="disabled"<%}%>><a href="javascript:postToUrl('<%=response.encodeRedirectURL("showFixedUrls.jsp")%>', {id:'<%=id%>',group:'<%=group%>',lgroup:'<%=lgroup%>',lang:'pt',dbFilter:'<%=dbFilter%>',collCenterFilter:'<%=collCenterFilter%>',order:'<%=order%>',url:'<%=url_E%>',brokenUrl:'<%=brokenUrl_E%>'});">Português</a></li>
                                        <li <%if(lang.equals("es")) {%> class="disabled"<%}%>><a href="javascript:postToUrl('<%=response.encodeRedirectURL("showFixedUrls.jsp")%>', {id:'<%=id%>',group:'<%=group%>',lgroup:'<%=lgroup%>',lang:'es',dbFilter:'<%=dbFilter%>',collCenterFilter:'<%=collCenterFilter%>',order:'<%=order%>',url:'<%=url_E%>',brokenUrl:'<%=brokenUrl_E%>'});">Español</a></li>
                                        <!--li <%if(lang.equals("fr")) {%> class="disabled"<%}%>><a href="javascript:postToUrl('<%=response.encodeRedirectURL("showFixedUrls.jsp")%>', {id:'<%=id%>',group:'<%=group%>',lgroup:'<%=lgroup%>',lang:'fr',dbFilter:'<%=dbFilter%>',collCenterFilter:'<%=collCenterFilter%>',order:'<%=order%>',url:'<%=url_E%>',brokenUrl:'<%=brokenUrl_E%>'});">Francés</a></li-->
                                    </ul>
                                </li>
                                <li class="dropdown">
                ...
                <div class="urlEditor">
                    <div class="urlLine">
                        <div class="seg-q">
                            ...
                            <%if(undo) {%>
                               <div class="URL-tested">URL: <a target="_blank" href="<%=url_E%>"><%=url_D%></a>  &#8594; <a target="_blank" href="<%=brokenUrl_E%>"><%=brokenUrl_D%></a></div>
                            <%} else {%>
                                <div class="URL-tested">URL: <a target="_blank" href="<%=brokenUrl_E%>"><%=brokenUrl_D%></a>  &#8594; <a target="_blank" href="<%=url_E%>"><%=url_D%></a></div>
                            <%}%>
                        </div>
                    </div>
